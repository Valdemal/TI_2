...
namespace matrix {
    ...
    private:
        ...
        inline baseType at(size_t i, size_t j) const { return _values.at(i).at(j); };
    ...
    public:
        ...
        // Возвращает константную ссылку на i-ю строку матрицы
        const std::vector<baseType> &operator[](size_t i) const { return _values[i]; }

        // Выводит матрицу _systemMatrix в поток out
        ...
        // Считывает матрицу _systemMatrix из потока in
        ...
        /* Возвращает значение ИСТИНА, если размеры матриц _systemMatrix и b совпадают,
         * иначе ЛОЖЬ */
    ...
    /* Прибавляет к вектору modifyV вектор refV умноженный на число fi*/
    template<typename baseType>
    void addVectorMulOnNumToVector
